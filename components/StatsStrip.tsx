  ...
  return (
    <div
      ...
      {stats.map((stat, index) => (
        <div
          key={index}
          className="px-4 md:px-8 lg:px-12 py-8 md:py-10 opacity-0"
          style={{
            borderRight: index < 2 ? '1px solid var(--glass-border)' : 'none',
            borderBottom: index < 2 ? '1px solid var(--glass-border) md:border-b-0' : 'none',
            animation: `fadeUp 0.6s forwards`,
            animationDelay: `${0.1 + index * 0.1}s`,
          }}>
          <div
            className="font-sans text-2xl md:text-3xl font-bold leading-tight mb-2"
            style={{
